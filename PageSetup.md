...
## Link with Red Line in Table of Contents

Table of Contents ထဲမှာရှိတဲ့ ခေါင်းစဉ်တွေမှာ အနီရောင်ဘောင်တွေ ပေါ်နေတာဟာ **`hyperref`** package ကြောင့် ဖြစ်တာပါ။ LaTeX က မာတိကာ (Table of Contents) ထဲမှာရှိတဲ့ ခေါင်းစဉ်တွေကို link တွေအဖြစ် အလိုအလျောက် ပြောင်းပေးလိုက်တဲ့အခါ၊ ဒါဟာ link ဖြစ်ကြောင်း သိသာအောင် အနီရောင် ဘောင်ခတ်ပြီး ပြပေးနေတာ ဖြစ်ပါတယ်။

ဒါကို စိတ်ပူစရာမလိုပါဘူး။ ဒီအနီရောင်ဘောင်တွေဟာ **PDF ထဲမှာပဲ မြင်ရတာဖြစ်ပြီး စာရွက်နဲ့ Print ထုတ်လိုက်ရင် ပါလာမှာ မဟုတ်ပါဘူး။**

အကယ်၍ ဒီအနီရောင်ဘောင်တွေကို မမြင်ချင်တော့ဘူး (သို့မဟုတ်) အရောင်ပြောင်းချင်တယ်ဆိုရင် အောက်ပါအတိုင်း ပြင်ဆင်နိုင်ပါတယ်။

---

### ၁။ အနီရောင်ဘောင်ကို လုံးဝ ဖျောက်လိုက်နည်း
Preamble အပိုင်း ( `\begin{document}` ရဲ့ အပေါ်) မှာရှိတဲ့ `\usepackage{hyperref}` နေရာမှာ အခုလို အစားထိုးလိုက်ပါ -

```latex
\usepackage[hidelinks]{hyperref} % link ဘောင်များကို ဖျောက်ထားရန်
```

### ၂။ ဘောင်မပါဘဲ စာသားကိုပဲ အရောင်ပြောင်းနည်း
Professional ဆန်ချင်ရင် ဘောင်ခတ်မယ့်အစား link စာသားလေးတွေကိုပဲ အရောင်ပြောင်းထားတာ ပိုလှပါတယ်။

```latex
\usepackage{xcolor} % အရောင်များ သုံးနိုင်ရန်
\usepackage{hyperref}
\hypersetup{
    colorlinks=true,    % ဘောင်မပြဘဲ စာသားကို အရောင်ပြောင်းမည်
    linkcolor=blue,     % မာတိကာ link များကို အပြာရောင်ထားမည်
    filecolor=magenta,      
    urlcolor=cyan,
}
```
